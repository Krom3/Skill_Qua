...
public class Skill_DroneA : SkillActive
{
    ...
    {
        objDrone = InGameManager.instance.manager_playerSkill.objDroneA;
        trnDroneMissile = InGameManager.instance.manager_playerSkill.trnDroneMissileA;
